...
const Header = (props) => {
  return (
    <header className='w-100 navbar navbar-dark bg-dark justify-content-around'>
        ...
        <div  data-bs-toggle="offcanvas" data-bs-target="#carrinhoOffCanvas" id="carrinho" role='button' className='position-relative d-flex align-items-center justify-content-center gap-2'>
