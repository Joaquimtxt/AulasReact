        ...
        {props.carrinhoItem.length === 0 ? (
          ...
          <>
                  ...
                  <div className="w-100">
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="border border-dark-subtle border-1 d-flex align-items-center rounded-4 gap-2">
                        ...
                        <button className="btn border-0" onClick={()=>  props.onUpdateCarrinho(item, item.quantidade + 1)}>+</button>
                      </div>
            ...
            <div className="d-flex justify-content-between text-light fs-4">
              ...
              <button id="addCarrinho" className="btn btn-success desconto border-0 w-100 mt-2 fs-5">
                Finalizar compra
              </button>
          </>
        )}
...
export default CarrinhoOffCanva;
